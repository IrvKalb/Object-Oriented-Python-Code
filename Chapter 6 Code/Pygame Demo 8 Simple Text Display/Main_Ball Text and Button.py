# pygame demo 8 Drawing Simple text
...
frameCountLabel = SimpleText(window, (100, 15),
                            'Program has gone through this many loops:', WHITE)
frameCountDisplay = SimpleText(window, (300, 35), '0', WHITE)
