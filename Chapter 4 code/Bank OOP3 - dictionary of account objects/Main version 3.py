...
accountsDict[joesAccountNumber].deposit(50.00, 'JoesPassword')
accountsDict[marysAccountNumber].withdraw(345.67, 'MarysPassword')
accountsDict[marysAccountNumber].deposit(100.00, 'MarysPassword')
...
accountsDict[newAccountNumber].deposit(100.00, userPassword)
